...
"""
        ...
        low_coverage_files = [(f, data) for f, data in files.items() 
    ...
    def run_security_tests(self) -> bool:
        ...
        try:
            result = subprocess.run([
                sys.executable, str(restler_script), 
                "--ci", "--suite", "smoke"
...
def main():
    ...
    parser.add_argument("--ci", action="store_true",
                       help="Run in CI mode (fail on coverage below threshold)")
