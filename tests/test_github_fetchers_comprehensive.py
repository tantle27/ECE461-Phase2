...
class TestFetchRepoTree:
    ...
    def test_fetch_repo_tree_with_ref(self, mock_get):
        ...
        mock_get.assert_any_call("https://api.github.com/repos/owner/repo/git/trees/commit_sha_123", params={"recursive": "1"})
    ...
    def test_fetch_repo_tree_without_ref(self, mock_get):
        ...
        mock_get.assert_any_call("https://api.github.com/repos/owner/repo/git/trees/main_sha_456", params={"recursive": "1"})
...
class TestFetchCommits:
    ...
    def test_fetch_commits_without_ref(self, mock_get):
        ...
        result = fetch_commits("owner/repo", None)
...
class TestFetchReadme:
    ...
    def test_fetch_readme_without_ref(self, mock_get):
        ...
        result = fetch_readme("owner/repo", None)
