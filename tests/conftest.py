...
def mock_git_client():
    ...
    client.read_readme.return_value = "# Test README\n\nThis is a test repository."
...
def mock_gen_ai_client():
    ...
    client.get_performance_claims = AsyncMock(
        return_value={
            "has_metrics": 1,
...
def mock_hf_client():
    ...
    client.get_dataset_info.return_value = {"normalized_likes": 0.8, "normalized_downloads": 0.9}
