...
from app.scoring import (
    ModelRating, _run_async, _calculate_net_score,
    _build_model_rating, _score_artifact_with_metrics,
    _METRICS_CALCULATOR
)
...
class TestIntegrationScenarios:
    ...
    def test_full_scoring_pipeline(self):
        ...
        with patch.object(_METRICS_CALCULATOR, 'analyze_entry', new_callable=AsyncMock) as mock_analyze:
            ...
            expected_net = (
                1.0 * 0.30 +      # license
                0.8 * 0.20 +      # ramp_up_time  
                0.9 * 0.15 +      # dataset_and_code_score
                0.7 * 0.10 +      # performance_claims
                0.6 * 0.15 +      # bus_factor
