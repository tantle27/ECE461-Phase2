...
class TestDataClasses:
    ...
    def test_artifact_metadata_creation(self):
        ...
        metadata = ArtifactMetadata(id="test-id", name="test-name", type="model", version="1.0.0")
...
class TestUtilityFunctions:
    ...
    def test_artifact_to_dict(self):
        ...
        expected = {
            "metadata": {"id": "test", "name": "name", "type": "model", "version": "1.0"},
            "data": {"model_link": "https://example.com"},
        }
...
class TestArtifactStorage:
    ...
    def setup_method(self):
        ...
        from app.core import _RATINGS_CACHE, _REQUEST_TIMES, _STATS, _STORE, _TOKENS
