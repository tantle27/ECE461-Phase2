...
class PerformanceAnalyzer:
    ...
    def run_test_suite_analysis(self) -> Dict[str, Any]:
        ...
        try:
            ...
            # Extract test counts
            summary_line = [line for line in lines if "passed" in line and "failed" in line or 
                          "passed" in line and "skipped" in line][-1:] if lines else []
...
def main():
    ...
    try:
        ...
        print(f"📄 Documentation: docs/performance_report_draft.md")
