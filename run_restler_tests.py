...
class RESTlerRunner:
    ...
    def find_restler_executable(self) -> Optional[str]:
...
app.run(host='127.0.0.1', port=5000, debug=False)
    ...
    def run_restler_test(self, test_type: str = "smoke") -> bool:
        ...
        cmd = [
            ...
            "--dictionary_file", str(self.results_dir / "compile" / "dict.json"),
            "--settings", str(self.results_dir / "compile" / "engine_settings.json"),
            "--output_dir", str(test_dir),
            "--time_budget", "0.5"  # 30 minutes for CI
        ]
